    ...
    let logs = client.channels.cache.get(logsID)
      if(person > limit - 1) {
        ...
        if (logs) { return logs.send({ embed: embed }) } } ).catch(err => {
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Breaking the role create limits", "Diemin dulu kalo nglunjak baru")
            .setColor("#FF0000")
            .setFooter(dev)
            .setTimestamp()
        ...
        db.add(`${role.guild.id}_${user.id}_rolecreate`, 1)
          ...
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Creating Roles...", `${pog || 0}/${limit || 0}`)
            .setColor("GREEN")
            .setFooter(dev)
            .setTimestamp()
    ...
    if(person > limit - 1) {
        ...
        if (logs) { return logs.send({ embed: embed }) } } ).catch(err => {
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Breaking the role delete limits", "Diemin dulu kalo nglunjak baru")
            .setColor("#FF0000")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) } } ) } 
      ...
      db.add(`${role.guild.id}_${user.id}_roledelete`, 1)
        ...
        let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Deleting Roles...", `${pog || 0}/${limit || 0}`)
            .setColor("GREEN")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) }
      ...
      if (punish === "ban") {
        ...
        if (logs) { return logs.send({ embed: embed }) } }).catch(err => {
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Breaking the channel create limits", "Diemin dulu kalo nglunjak baru")
            .setColor("#FF0000")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) } }) } 
        ...
        db.add(`${channel.guild.id}_${user.id}_channelcreate`, 1)
          ...
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Creating channels...", `${pog || 0}/${limit || 0}`)
            .setColor("GREEN")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) }
      ...
      if (punish === "ban") { channel.guild.members.ban(user.id).then(hahsh => {
        ...
        if (logs) { logs.send({ embed: embed }) } }).catch(err => {
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Breaking the channel delete limits", "Diemin dulu kalo nglunjak baru")
            .setColor("#FF0000")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) } } ) } 
      ...
      db.add(`${channel.guild.id}_${user.id}_channeldelete`, 1)
        ...
        let bruh = db.get(`channeldelete_${channel.guild.id}`)
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Deleting channels...", `${pog || 0}/${limit || 0}`)
            .setColor("GREEN")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) }
      ...
      if(person > limit - 1) {
        ...
        if (logs) { logs.send({ embed: embed }) } }).catch(err => {
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Breaking the kick limits", "Diemin dulu kalo nglunjak baru")
            .setColor("#FF0000")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) } } ) } 
        ...
        let bruh = db.get(`kicklimit_${member.guild.id}`)
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Kicking members...", `${pog || 0}/${limit || 0}`)
            .setColor("GREEN")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) } }
      ...
      if(person > limit - 1) {
        ...
        if (logs) { logs.send({ embed: embed }) } }).catch(err => {
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Breaking ban limits", "Diemin dulu kalo nglunjak baru")
            .setColor("#FF0000")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) } } ) } 
      ...
      let pog = db.get(`${member.guild.id}_${user.id}_banlimit`)
        let bruh = db.get(`banlimit_${member.guild.id}`)
          let embed = new Discord.MessageEmbed()
            .setThumbnail(user.displayAvatarURL({ dynamic: true }))
            .setAuthor(`${user.tag}  |  Mencoba Melakukan Raid`)
            .addField("Banning members...", `${pog || 0}/${limit || 0}`)
            .setColor("GREEN")
            .setFooter(dev)
            .setTimestamp()
        if (logs) { logs.send({ embed: embed }) }
